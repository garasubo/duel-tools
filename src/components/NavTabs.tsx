...
const TABS: { id: TabId; label: string; to: string; hash: string }[] = [
  { id: 'record', label: '記録する', to: '/record', hash: '' },
  { id: 'history', label: '履歴', to: '/record#history', hash: '#history' },
  { id: 'stats', label: '統計', to: '/record#stats', hash: '#stats' },
];
